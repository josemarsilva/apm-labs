...
#### [3.4.1. Performance Test - injetar (Browser, Curl, Postman, SoapUI e JMeter) vs rebater (HTTP e JSON WebServer)](./README-guia-exec-demo-teste-INJETAR-REBATER-web-json-server.md)
